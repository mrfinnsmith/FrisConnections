      ...
      <div className="space-y-6 page-text">
        ...
        <section>
          ...
          <div className="space-y-2">
            ...
            <p>
              <strong>Watch for red herrings:</strong> Some words might seem to fit multiple groups
            </p>
            <p>
        ...
        <section>
          ...
          <p>
            Solve all four groups to win! Your progress saves automatically, and you can share your
            results with an emoji pattern that shows which difficulty levels you solved.
          </p>
        </section>
      </div>
    </div>
