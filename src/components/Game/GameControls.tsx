...
function GameControls({ gameState, onSubmit, onShuffle, onDeselectAll }: GameControlsProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <div className="flex justify-center gap-1">{mistakeDots}</div>
      </div>
      ...
      <div className="flex justify-center gap-2">
        ...
        <button className="game-button primary" onClick={onSubmit} disabled={!gameData.canSubmit}>
          Submit
        </button>
      </div>
    </div>
